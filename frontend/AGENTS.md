# Score Pion — Frontend Developer Guide

This guide helps developers (and AI agents) work effectively in the frontend directory.
...
- `ticket` — Asana ticket lifecycle (load/create/close). Requires the Asana MCP (see root `AGENTS.md`).
- `find-skills` — Discover and install skills from the open Agent Skills ecosystem

**Frontend-specific skills** (Angular context):
- `ui-standards` — Strict guidelines for building consistent UI components, forms, tables, modals, and actions
...
- `../AGENTS.md` — Monorepo-wide AI developer guide (MCP servers, full project structure)
